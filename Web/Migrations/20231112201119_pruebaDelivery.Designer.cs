...
namespace Web.Migrations
{
    ...
    [Migration("20231112201119_pruebaDelivery")]
    partial class pruebaDelivery
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web.Models.ProductosPedido", b =>
                {
                    ...
                    b.Property<int>("PlatoRefId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("BebidaRefId");

                    b.HasIndex("DeliveryId");

                    b.HasIndex("PlatoRefId");
            ...
            modelBuilder.Entity("Web.Models.ProductosPedido", b =>
                {
                    b.HasOne("Web.Models.Bebida", "Bebida")
                        .WithMany()
                        .HasForeignKey("BebidaRefId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Web.Models.Plato", "Plato")
                        .WithMany()
                        .HasForeignKey("PlatoRefId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
